...
<header class="topnavbar-wrapper">
   ...
   <nav class="navbar topnavbar">
      <!-- START navbar header-->
      <div class="navbar-header"><a class="navbar-brand" href="dashboard.php">
            <div class="brand-logo"><img class="img-fluid" src="img/logo/work-wise-full.png" alt="App Logo"></div>
            <div class="brand-logo-collapsed"><img class="img-fluid" src="img/logo/work-wise-small.png" alt="App Logo"></div>
         </a></div>
         <!-- END navbar header-->
      <!-- START Left navbar-->
      ...
      <ul class="navbar-nav flex-row">
         ...
         <li class="nav-item dropdown dropdown-list toggle-margin"><a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-toggle="dropdown"><em class="icon-bell"></em><span class="badge badge-danger">11</span></a><!-- START Dropdown menu-->
